...
const Components = {
  ...
  icons: {
    ...
    withdrawal: '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path><circle cx="5" cy="12" r="3"></circle></svg>',
  ...
  initMobileMenu() {
    ...
    // Close menu on escape key - attach only once to prevent listener accumulation
          ...
          <aside class="sidebar" role="navigation" aria-label="Navegación principal">
            ...
            <nav>
              <ul class="sidebar-nav" role="menu">
                ...
                <li><a href="#/director/withdrawals" role="menuitem">${this.icons.withdrawal}<span>Retiros</span></a></li>
...
// Super Admin Layout
  ...
  directorNav: [
    ...
    { path: '/director/withdrawals', icon: 'directions_walk', label: 'Retiros' },
