...
Views.directorCourses = function() {
      ...
      <div class="h-screen flex overflow-hidden bg-gray-50 dark:bg-background-dark">
        ...
        <aside id="sidebar" class="w-64 bg-sidebar-dark text-gray-300 flex-shrink-0 flex-col transition-all duration-300 mobile-hidden border-r border-indigo-900/50 shadow-2xl z-50">
          <div class="h-20 flex items-center justify-between px-6 border-b border-indigo-900/50">
            ...
            <button class="desktop-hidden text-gray-400 hover:text-white p-1" onclick="Views.directorCourses.toggleSidebar()">
        ...
        <div id="sidebar-backdrop" class="fixed inset-0 bg-black/50 z-40 hidden desktop-hidden" onclick="Views.directorCourses.toggleSidebar()"></div>
        ...
        <main class="flex-1 flex flex-col overflow-hidden">
          ...
          <header class="h-20 bg-white dark:bg-card-dark border-b border-gray-200 dark:border-border-dark flex items-center justify-between px-4 md:px-8 shrink-0 shadow-sm z-10">
            <div class="flex items-center gap-4">
              <button onclick="Views.directorCourses.toggleSidebar()" class="p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-slate-700 desktop-hidden">
  ...
  Views.directorCourses.toggleSidebar = toggleSidebar;
