...
Views.directorDevices = async function() {
  ...
  // Navigation items (same as other modules, Dispositivos active)
  ...
  Views.directorDevices.toggleMobileSidebar = function() {
      ...
      <div class="flex h-screen overflow-hidden bg-gray-50 dark:bg-slate-900">
        ...
        <aside id="sidebar" class="w-64 bg-sidebar-dark text-gray-300 flex-shrink-0 flex-col transition-all duration-300 mobile-hidden border-r border-indigo-900/50 shadow-2xl z-50">
          <div class="h-20 flex items-center justify-between px-6 border-b border-indigo-900/50">
            ...
            <button class="desktop-hidden text-gray-400 hover:text-white p-1" onclick="Views.directorDevices.toggleMobileSidebar()">
        ...
        <div id="sidebar-backdrop" class="fixed inset-0 bg-black/50 z-40 hidden desktop-hidden" onclick="Views.directorDevices.toggleMobileSidebar()"></div>
        ...
        <main class="flex-1 flex flex-col overflow-hidden relative">
          ...
          <header class="h-20 bg-white dark:bg-card-dark border-b border-border-light dark:border-border-dark flex items-center justify-between px-4 md:px-8 z-10 shadow-sm">
            <div class="flex items-center gap-4">
              <button class="desktop-hidden text-muted-light dark:text-muted-dark hover:text-primary transition-colors" onclick="Views.directorDevices.toggleMobileSidebar()">
