...
class TestBugR4_1_PrefsIterationValidation:
    ...
    def test_detect_no_ingreso_validates_prefs_type(self):
        ...
        has_pref_value_pattern = "pref_value = prefs.get" in source and \
                                 "isinstance(pref_value, list)" in source
        has_direct_isinstance = "isinstance(prefs.get(template_key" in source or \
                               "isinstance(prefs[template_key]" in source
