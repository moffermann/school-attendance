...
class TestR18FILE1UploadValidation:
    ...
    def test_attach_photo_validates_event_exists(self):
        ...
        if method_match:
            ...
            has_validation = (
                "ALLOWED_MIME_TYPES" in method_source or
                "content_type" in method_source
            )
...
class TestR18WORK3CleanupBatching:
    ...
    def test_cleanup_photos_has_limit(self):
        ...
        has_limit = (
            "limit" in source.lower() or
            "batch" in source.lower() or
            "[:100]" in source or
            "[:1000]" in source
        )
        ...
        assert has_loop, (
            "cleanup_photos should iterate over photos (has processing loop)."
        )
...
class TestR18MW2RateLimiter:
    ...
    def test_rate_limiter_exists(self):
        ...
        has_default = "default" in source.lower()

        assert has_limiter, (
            "Rate limiter should be configured with Limiter class."
        )
...
class TestR18SCHEMA1IDValidation:
    ...
    def test_attendance_student_id_validated(self):
        ...
        has_field_import = "Field" in source
        ...
        assert has_student_id, (
            "Attendance schema should define student_id field."
        )
...
class TestR18SCHEMA2StringValidation:
    ...
    def test_absence_comment_has_max_length(self):
        ...
        if has_comment:
            ...
            assert has_field, (
                "Absence schema should use Field() for validation."
            )
...
class TestR18SCHEMA3EmailValidation:
    ...
    def test_auth_email_validated(self):
        ...
        has_email_validator = (
            "EmailStr" in source or
            "email_validator" in source or
            "@" in source
        )

        assert has_email, (
            "Auth schema should have email field."
        )
...
class TestR18TMPL1TemplateEscaping:
    ...
    def test_components_has_escape_function(self):
        ...
        has_escape = (
            "escapeHtml" in content or
            "escape" in content.lower() or
            "sanitize" in content.lower()
        )

        assert has_escape, (
            "Components should have HTML escape function for user data."
        )
...
class TestR18TMPL2ModalSanitization:
    ...
    def test_modal_uses_innerhtml_safely(self):
        ...
        if has_modal and has_innerhtml:
            ...
            assert has_escape, (
                "Modal should have escapeHtml function available for content."
            )
...
class TestR18API2SESErrorHandling:
    ...
    def test_ses_has_error_handling(self):
        ...
        assert has_try_except and has_logging, (
            "SES client should have error handling with logging."
        )
...
class TestR18API3RedisManagement:
    ...
    def test_token_blacklist_has_redis(self):
        ...
        assert has_redis and has_fallback, (
            "Token blacklist should use Redis with memory fallback."
        )
...
class TestR18API4APITimeouts:
    ...
    def test_whatsapp_has_timeout(self):
        ...
        assert has_timeout, (
            "WhatsApp client should have timeout configured for API calls."
        )
...
class TestR18WORK4SchedulerShutdown:
    ...
    def test_scheduler_has_shutdown_handling(self):
        ...
        assert has_shutdown and has_signal, (
            "Scheduler should handle shutdown signals gracefully."
        )
...
class TestR18MW4ExceptionHandler:
    ...
    def test_attendance_api_safe_errors(self):
        ...
        # Check for exception handling
        has_try_except = "try:" in source or "except" in source
        has_http_exception = "HTTPException" in source

        assert has_http_exception, (
            "Attendance API should use HTTPException for errors."
        )
...
class TestR18FILE3MagicBytesValidation:
    ...
    def test_attendance_service_validates_magic_bytes(self):
        ...
        has_magic_validation = (
            "_validate_magic_bytes" in source or
            "magic" in source.lower() or
            "\\xff\\xd8" in source  # JPEG magic bytes
        )

        assert has_magic_validation, (
            "Attendance service should validate file magic bytes."
        )
...
class TestR18SCHEMA4ListLimits:
    ...
    def test_broadcast_has_scope_validation(self):
        ...
        assert has_list or has_scope, (
            "Notifications schema should handle list recipients."
        )
...
class TestR18WORK5JobLogging:
    ...
    def test_detect_no_ingreso_has_logging(self):
        ...
        has_info_log = "logger.info" in source or "logger.warning" in source

        assert has_logger, (
            "detect_no_ingreso should have logging statements."
        )
